...
define('HTTP_IMAGES_SECURE_PATH', HTTP_BASE_SECURE_URL.'assets/images/');
define('HTTP_JS_PATH', $config['base_url'].'assets/js/');
define('HTTP_JS_SECURE_PATH', HTTP_BASE_SECURE_URL.'assets/js/');
...
define("HTTP_BASE_URL",$config['base_url']);
